  ...
  try {
    ...
    if (name === 'taxme_results') {
      ...
      if (at < 0) {
        ...
        // whose breadcrumb does not contradict the entry we clicked, and which
        // still has no such word in its content.
        return text({
